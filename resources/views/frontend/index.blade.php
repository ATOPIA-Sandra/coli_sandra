                ...
                <div class="col-lg-6 about-text wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                            ...
                            <h5>Envoyer des colis/</br>Rechercher un transporteur</h5>
                            <p class="m-0">Envoyez vos colis à bon marché partout dans le monde à travers des particuliers de confiance.</p>
                        </div>
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.7s">
                            <i class="fa fa-shipping-fast fa-3x text-primary mb-3"></i>
                            <h5>Transporter des colis/publier une annonce</h5>
                            <p class="m-0">Amortissez vos frais de voyage en transportant des colis pour des particuliers de confiance.</p>
                        </div>
                    </div>
